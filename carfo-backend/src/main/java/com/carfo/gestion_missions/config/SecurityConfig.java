...
import com.carfo.gestion_missions.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        return identifier -> agentRepository.findByEmail(identifier)
            .or(() -> agentRepository.findByUsername(identifier))
            .orElseThrow(() -> new UsernameNotFoundException("Agent non trouvé : " + identifier));
    }
